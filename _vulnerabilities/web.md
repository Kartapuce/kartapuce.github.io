...
gallery7:
  - url: /assets/images/web/idor.png
    image_path: assets/images/web/idor.png
---
...
An attacker manipulates identifiers in the URL or parameters in order to access forbidden objects.
